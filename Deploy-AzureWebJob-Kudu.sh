...
DEPLOYMENT_SOURCE_TWITTER_EXTRACTOR=$DEPLOYMENT_SOURCE\\jobs\\continuous\\TwitterExtractorWebJob
...
echo "deploy source is $DEPLOYMENT_SOURCE_TWITTER_EXTRACTOR"
...
if [ -e "$DEPLOYMENT_SOURCE_TWITTER_EXTRACTOR\\package.json" ]; then
  cd $DEPLOYMENT_SOURCE_TWITTER_EXTRACTOR
